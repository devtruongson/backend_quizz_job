...
-- Chạy các câu lệnh này theo thứ tự để tạo dữ liệu mẫu
...
-- 3. Tạo Vocabulaires (Từ vựng theo chủ đề)
...
-- 4. Tạo Vocabulaire Questions (Câu hỏi từ vựng)
...
-- 5. Tạo User Vocabulaires (Tiến độ học của user)
...
-- 6. Tạo User Exams (Kết quả bài thi của user)
...
-- 7. Tạo Exam Questions (Câu hỏi bài thi)
